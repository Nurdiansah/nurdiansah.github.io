    ...
    <header class="masthead ">
      <div class="container">
        ...
        <a class="btn btn-danger btn-xl text-uppercase js-scroll-trigger" href="https://api.whatsapp.com/send?phone=6281299245776">HUBUNGI KAMI <i class="fab fa-whatsapp"></i></a>
      </div>
    </header>
    <!-- </section> -->
    <!-- Body -->
    <div class="page-section">
      ...
      <section class="page-section bg-light" id="portfolio">
        ...
        <div class="text-center">
          <a class="btn btn-primary btn-l text-right js-scroll-trigger" href="index.php?p=portfolio">Lihat Lainnya</a>
        </div>
      </section>
